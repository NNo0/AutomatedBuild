...
RUN git clone https://github.com/sstephenson/rbenv.git /usr/local/rbenv/rbenv
RUN git clone https://github.com/sstephenson/ruby-build.git /usr/local/rbenv/rbenv/plugins/ruby-build

RUN echo 'export RBENV_ROOT="/usr/local/rbenv/rbenv"' >> /etc/profile.d/rbenv.sh
